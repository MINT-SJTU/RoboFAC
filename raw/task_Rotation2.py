...
@register_env("Rotation2-v1", max_episode_steps=200)
class Rotation2Env(BaseEnv):
    """
    Task Description
    ----------------
...
@register_env("Rotation2-gen1", max_episode_steps=200)
class Rotation2Env_gen1(BaseEnv):
...
@register_env("Rotation2-gen2", max_episode_steps=200)
class Rotation2Env_gen2(BaseEnv):
